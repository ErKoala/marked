...
function outputLink(cap, link) {
  if(cap[1] == 'youtube')
    if(np = /(v=|\/)([\w-]+)(&.+)?$/.exec(link.href))
      return '<div class="youtube-vid" style="background-image: url(\'http://img.youtube.com/vi/'+np[2]+'/default.jpg\'); width: 120px; height: 90px;" title="'+np[2]+'"></div>';
